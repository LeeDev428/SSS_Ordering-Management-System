...
// Fetch items from the 'items' table in the database with pagination
...
<body class="bg-gradient-to-br from-green-100 via-yellow-100 to-white min-h-screen">
    <!-- Navbar -->
    <header class="bg-green-600 text-white py-4 shadow-lg z-10 relative">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="relative">
                ...
                <div id="dropdownMenu" class="absolute right-0 mt-2 w-48 bg-white text-gray-700 rounded-lg shadow-lg hidden">
                    ...
                    <a href="../logout.php" class="block px-4 py-2 rounded-lg hover:bg-gray-100 transition">Logout</a> <!-- Adjusted path for logout -->
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <?php foreach ($items as $item): ?>
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Available Quantity: <?php echo $item['quantity']; ?></p>
